        ...
        <div className="w-full">
          <div className="w-[70%] mt-[12rem] mx-auto border-2 border-none rounded-xl px-10 pt-24 pb-7 shadow-xl">
            ...
            <form className="">
              ...
              <div className="mt-9 flex flex-col relative">
                <label
                  className="mb-1 font-semibold text-sm text-[#343434]"
                  htmlFor="password"
                >
                ...
                />
                <div className="absolute text-2xl items-center cursor-pointer right-3 top-9">
                  {open === false ? (
                    <IoMdEye onClick={passtoggle} />
                  ) : (
                    <IoIosEyeOff onClick={passtoggle} />
                  )}
                </div>
              </div>
              <p className="mt-1 pl-2 text-xs text-red-600">
              ...
              <div
                ...
                className="text-center my-9 w-full"
              >
                <LoginBtn />
              </div>
